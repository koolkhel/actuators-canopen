"""autogenerated by genpy from actuators_canopen/ElectromotorsStateExt.msg. Do not edit."""
import sys
...
class ElectromotorsStateExt(genpy.Message):
  ...
  _type = "actuators_canopen/ElectromotorsStateExt"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actuators_canopen/ElectromotorsState','uint16','uint8','uint8','uint8','uint16','uint8','uint8','uint8','uint8','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.basic_state is None:
        self.basic_state = actuators_canopen.msg.ElectromotorsState()
