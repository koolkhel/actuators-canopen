"""autogenerated by genpy from actuators_canopen/BallonetStateExt.msg. Do not edit."""
import sys
...
class BallonetStateExt(genpy.Message):
  ...
  _type = "actuators_canopen/BallonetStateExt"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """Header header

BallonetState basic_state
...
================================================================================
MSG: actuators_canopen/BallonetState
Header header
...
"""
  ...
  _slot_types = ['std_msgs/Header','actuators_canopen/BallonetState','uint8','uint8','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BallonetStateExt, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.basic_state is None:
        self.basic_state = actuators_canopen.msg.BallonetState()
