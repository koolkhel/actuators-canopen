...
class SetEngineServoControlRequest(genpy.Message):
  _md5sum = "fd9a903bfe7af36423e86b8102c57ecd"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f.pack(_x.ctrl.angle, _x.ctrl.current, _x.ctrl.voltage))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ctrl.angle, _x.ctrl.current, _x.ctrl.voltage,) = _struct_3f.unpack(str[start:end])
      return self
...
class SetEngineServoControl(object):
  ...
  _md5sum = 'dae56f3a049d30f166add5cac2efb0d2'
